...
void balk::initialize() /* Initialization function. */
{
...
int balk::arrive(void) /* Arrival event function. */
{
    float delay;
...
void balk::depart(void) /* Departure event function. */
{
    int i;
    float delay;
...
void balk::update_time_avg_stats(void) /* Update area accumulators for time-average
                                    statistics. */
{
...
float balk::expon(float mean) /* Exponential variate generation function. */
{
